...
const addOne = (arr) => {
  // Solution code here...
  let arrOfNumbers = [];
  arr.forEach(num => arrOfNumbers.push(num + 1));
  return arrOfNumbers;
};
...
const addExclamation = (arr) => {
  // Solution code here...
  let arrOfStrings = [];
  arr.forEach(element => arrOfStrings.push(`${element}!`));
  return arrOfStrings;
};
...
const allUpperCase = (arr) => {
  // Solution code here...
  let toUpperArr = [];
  arr.forEach(element => toUpperArr.push(element.toUpperCase()));
  return toUpperArr;
};
